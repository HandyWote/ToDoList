...
class Ui_addW(QWidget):
    ...
    def setupUi(self, addW):
        ...
        self.verticalLayout.setContentsMargins(10, 10, 10, 10)  # 设置布局的边
    ...
    def saveBM(self):
        ...
        try:
            with open(mainUI.logPath, 'a', encoding='utf-8') as Date:
            ...
            QtWidgets.QMessageBox.warning(self, '错误', '日程删除失败！', QtWidgets.QMessageBox.Ok)  # 弹出警告框提示日志文件不存在
